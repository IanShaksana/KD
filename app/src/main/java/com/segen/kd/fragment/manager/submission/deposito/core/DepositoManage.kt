package com.segen.kd.fragment.manager.submission.deposito.core
...
import com.segen.kd.databinding.FragmentDepositoManageListBinding
...
class DepositoManage : Fragment(), DialogStatusSub.dialogListener {
    ...
    private fun background(status: String) {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            onSuccess(
                GentUtil().process(
                    this@DepositoManage.resources.getString(R.string.submitDepositoGetManager),
                    obj,
                    this@DepositoManage.requireContext()
                )
            )
        }
    }
