...
import com.segen.kd.databinding.Sub32DepositoCreateFragmentBinding
import com.segen.kd.dialog.*
import com.segen.kd.modelbody.DepositoCreate
...
//            binding.pengajuanTanggal.setText("2020-01-01")
    ...
    private fun background() {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            onSuccess(
                GentUtil().process(
                    this@Sub32DepositoCreate.resources.getString(R.string.submitDepositoCreate),
                    obj,
                    this@Sub32DepositoCreate.requireContext()
                )
            )
