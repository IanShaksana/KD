...
import com.segen.kd.databinding.Sub31LoanEditFragmentBinding
...
import com.segen.kd.modelbody.LoanEdit
...
//            binding.pengajuanTanggalAngsuranPertama.setText("2020-01-01")
    ...
    private fun backgroundInitial() {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            onSuccess(
                GentUtil().process(
                    this@Sub31LoanEdit.resources.getString(R.string.submitLoanGetDetail),
                    obj,
                    this@Sub31LoanEdit.requireContext()
                )
            )
        }
    }
    ...
    private fun backgroundEdit() {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            onSuccessEdit(
                GentUtil().process(
                    this@Sub31LoanEdit.resources.getString(R.string.submitLoanEdit),
                    obj,
                    this@Sub31LoanEdit.requireContext()
                )
            )
